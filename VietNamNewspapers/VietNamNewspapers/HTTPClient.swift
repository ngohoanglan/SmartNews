        ...
        let task = urlSession.dataTask(with: request, completionHandler: {
            ...
            if let responseError = error {
                ...
                if httpStatus.rawValue != 200 {
                    let statusError = NSError(domain:"com.thealllatestnews.vietnamnewspapers", code:httpStatus.rawValue, userInfo:[NSLocalizedDescriptionKey : "HTTP status code: \(httpStatus.rawValue) - \(httpStatus)"])
